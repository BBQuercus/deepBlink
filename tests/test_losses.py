...
from deepblink.losses import combined_bce_rsme
...
def test_combined_bce_rsme(tensor_true, tensor_pred):
    assert tf.is_tensor(combined_bce_rsme(tensor_true, tensor_pred))
